...
#
#   bash genetic_analysis/run_all.sh              # preflight, then run/submit 01-06
#   bash genetic_analysis/run_all.sh 01 02        # only those steps
#   DRY_RUN=1 bash genetic_analysis/run_all.sh    # print every command, execute nothing
#
...
HPC_DIR="$REPO_ROOT/genetic_analysis"
ensure_dirs "$LOG_DIR"
