...
cap <- c(
  ...
  sprintf("- **f** PRS-CS polygenic score association with ΔCT (red) and CT (blue) on each row; β per SD of score with 95%% CI; filled = p < 0.05. Schizophrenia (2025 GWAS): ΔCT p = %s EUR / %s pooled, CT p = %s / %s. Bipolar (2024; EUR and multi-ancestry arms) and ADHD (2023; EUR) are null for ΔCT (p = %s, %s, %s). C+T and SBayesRC give the same ΔCT pattern (SI); bipolar EUR reaches significance under C+T only. * p < 0.05, ** p < 0.01, *** p < 0.001 (uncorrected).",
          sp("SCZ25_EUR", "global_slope"), sp("SCZ25_META", "global_slope"),
          sp("SCZ25_EUR", "baseline_thickness"), sp("SCZ25_META", "baseline_thickness"),
          sp("BIP_eur", "global_slope"), sp("BIP_pooled", "global_slope"), sp("ADHD", "global_slope")),
