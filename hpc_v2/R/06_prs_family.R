...
#
# [hpc_v2 step 06.  Lifted from tools/prs_assoc_withinfamily.R and promoted to
#  a first-class pipeline step; the model is unchanged.  Consumes v1's imputed
#  score profiles (results/prs_imp/score_*.profile) -- v2 does not re-score.]
#
